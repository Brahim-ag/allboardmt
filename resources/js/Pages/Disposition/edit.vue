    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Modification de mise à la disposition 
            </h2>
        </template>
...
export default {
    ...
    data() {
        return {
            dispositionData: this.Disposition,
            domaine: [],
        };
    },
    props: ["Disposition"],
    methods: {
        ...
        postData() {
            axios
                .put(
                    "/api/disposition/update/" + this.dispositionData.id,
                ...
                .then((response) => {
                    if (response.status == 200) {
                        window.location.href =
                            "/disposition/" + this.dispositionData.employee_id;
                    }
                })
                .catch((err) => {
                    console.log(err);
