          ...
          <div class="col-span-6 sm:col-span-2">
            ...
            <div class="col-span-6 sm:col-span-2">
              ...
              <select
                ...
                "
              >
                <option v-for="(w, code) in wilayas" :key="code">
                  {{ w.name }}
                </option>
              </select>
            </div>
            <div class="col-span-6 sm:col-span-2">
              ...
              <select
                ...
                @input="findCommune()"
              >
                <option>{{ employe.dairaNaiss }}</option>
...
export default {
  ...
  methods: {
    ...
    findDaira(event) {
      ...
      this.codeSel = event.target.value;
      axios
        .get("/wilaya/" + event.target.value + ".json")
        .then((response) => (this.daira = response.data));
    },
    findCommune() {
      axios
        .get("/wilaya/" + this.codeSel + ".json")
