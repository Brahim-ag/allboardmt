        ...
        <div>
           <div class="container mx-auto shadow overflow-hidden sm:rounded-md">
              ...
              <option>20</option>
                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                <option>
                                    Commissions de Recours - لجان طعن
                                </option>
            ...
            <input
                    required
                    type="hidden"
                    v-model="echelonsData.employee_id"
                />
        </div>
...
export default {
    ...
    methods: {
        ...
        postData() {
            axios
                .put("/api/echelons/update/" + this.echelonsData.id, this.echelonsData)
                .then((response) => {
                    if (response.status == 200) {
                        window.location.href =
                            "/echelons/" + this.echelonsData.employee_id;
                    }
                })
                .catch((e) => {
                    console.log(e);
