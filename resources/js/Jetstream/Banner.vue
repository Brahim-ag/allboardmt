<template>
  <div>
    <div class="  bg-black">
      <div class="bg-black text-yellow-400 container mx-auto flex pt-8 pb-8">
        <div class="flex-initial pr-10">
          <h1 class="text-2xl">
            République algérienne démocratique et populaire
          </h1>
          <h2 class="text-xl">Ministère de l'Habitat de l'Urbanisme et de la Ville</h2>
        </div>
        <div class="flex-initial pr-10">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/d/df/Emblem_of_Algeria.svg"
            width="100"
            height="100"
          />
        </div>
        <div class="flex-initial pr-10">
          ...
          <h2 class="text-xl text-right">وزارة السكن العمران و المدينة</h2>
        </div>
      </div>
    </div>
    <div
      ...
      v-if="show && message"
    >
      <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-2 lg:px-8">
