...
use App\Models\Postesup;
use Illuminate\Http\Request;
use App\Models\Team;
use Inertia\Inertia;

class PostesupsController extends Controller
{
    ...
    public function index(Request $request,$id)
    {
        ...
        if (!$user) {
            ...
            if($user->hasTeamPermission($team, 'read')){
                ...
                return Inertia::render('Postesup/index',[
                    'employe_id' => $id
                ]);
    ...
    public function getAll($id){
        ...
        return Employee::find($id)->Postesups;
    ...
    public function create(Request $request,$id)
    {
        ...
        if (!$user) {
            ...
            if($user->hasTeamPermission($team, 'read')){
                ...
                return Inertia::render('Postesup/create',[
                    'employee_id' => $id
                ]);
    ...
    public function store(Request $request)
    {
        ...
        return Postesup::create($request->all());
    ...
    public function show(Request $request,$id)
    {
        ...
        if (!$user) {
            ...
            if($user->hasTeamPermission($team, 'read')){
                ...
                return Inertia::render('Postesup/show',[
                    'employee' => $employee,
                ]);
    ...
    public function edit(Request $request,$id)
    {
        ...
        if (!$user) {
            ...
            if($user->hasTeamPermission($team, 'read')){
                ...
                $Postesup = Postesup::findOrFail($id);

        return Inertia::render('Postesup/edit', [
            'Postesup' => $Postesup,
        ]);
    ...
    public function update(Request $request)
    {
        ...
        $Postesup = Postesup::findOrFail($request->id);
        $Postesup->update($request->all());
