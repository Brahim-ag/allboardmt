...
class EchelonsController extends Controller
{
    ...
    public function index(Request $request,$id)
    {
        ...
        if (!$user) {
            ...
            if($user->hasTeamPermission($team, 'read')){
                ...
                return Inertia::render('Echelon/index',[
                    'employe_id' => $id
                ]);
    ...
    public function getAll($id){
        ...
        return Employee::find($id)->echelons;
    ...
    public function create(Request $request,$id)
    {
        ...
        if (!$user) {
            ...
            if($user->hasTeamPermission($team, 'read')){
                ...
                return Inertia::render('Echelon/create',[
                    'employee_id' => $id
                ]);
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            //'typeComm'=> 'required',
           // 'numberApp'=> 'required',
            //'dateSignApp'=> 'required',
            'employee_id' => 'required'
        ]);

        return Echelon::create($request->all());
    ...
    public function show(Request $request,$id)
    {
        ...
        if (!$user) {
            ...
            if($user->hasTeamPermission($team, 'read')){
                ...
                return Inertia::render('Echelon/show',[
                    'employee' => $employee,
                ]);
    ...
    public function edit(Request $request,$id)
    {
        ...
        if (!$user) {
            ...
            if($user->hasTeamPermission($team, 'read')){
                ...
                $Echelon = Echelon::findOrFail($id);

        return Inertia::render('Echelon/edit', [
            'Echelon' => $Echelon,
        ]);
    ...
    public function update(Request $request)
    {
        ...
        $Echelon = Echelon::findOrFail($request->id);
